...
--
-- Host: localhost:3306
-- Generation Time: Nov 18, 2016 at 06:22 AM
...
(19, 'HAMILTON 汉米尔顿 JAZZMASTER 爵士系列 H42515785 男款机械表', 0, '典雅小三针，简约耐看，商务风格，再到好价~', '汉米尔顿Hamilton于1892年成立于美国宾夕法尼亚州兰开斯特市，是世界上最大的钟表制造商和经销商Swatch集团的成员。这款爵士大师H42515785男款机械腕表，采用ETA-2895-2的机芯，是2892的小三针版，27钻，28800次/小时，背透设计。深灰色磨砂金属光泽表盘，银色夜光剑型表针，3点钟日期小窗，6点钟小盘为秒针盘，外壳采用银色精钢材质，黑色牛皮表带和整体的配色非常的和谐，40mm表径，50m日常防水。风格简约适合商务人士佩戴。', '2016-11-15 22:23:10', 2),
(20, 'SONY 索尼 ILCE-7M2K 28-70mm镜头 标准单镜头套装', 0, '全金属机身，5轴防抖技术', '作为全画幅无反相机A7的新款，ILCE-7M2（A7 Mark2）则是全球首款搭载有5轴防抖技术的全画幅无反相机。外观方面，A7 II沿用了前代的全金属机身，并优化了快门按键与手柄位的调节拨轮，更加符合人体工学设计。最大的亮点是采用了机身5轴防抖技术，包括有垂直、水平、垂直翻转、水平翻转和滚转5个方向，可使用户在拍摄照片时得到最高4.5档的防抖补偿。对焦采用了最新的相位差算法，拥有117个相位差和25个反差式对焦检测，可使对焦速度提升30%。', '2016-11-15 22:25:25', 2),
(21, '预售： iRobot Roomba 980 智能扫地机器人 旗舰款', 0, 'Evolution Robotics 是一家提供人工智能技术及解决方案的美国公司，其合作伙伴包括SONY、Bandai甚至US Navy美国海军，其实力可见一斑。我站曾多次推荐过Roomba系列的770、780、780等款型，口碑一向不错。', '相比两年之前发布的iRobot Roomba 880，新款的Roomba 980加入了iRobot的VSLAM（Vision Simultaneous Localization and Mapping）技术，在清洁房间的同时可以绘制房间的地图，以知晓哪些地方需要清洁、哪些地方够不到，在下次清理的同时速度能够大大加快。2016年iRobot最新款Roomba 980扫地机器人还使用了AeroForce强力真空吸尘系统，双反向旋转技术让清洁效果更好，强力提升50%的效率，最大吸尘面积可达到185平方米。', '2016-11-15 22:26:08', 2);
...
INSERT INTO `markzhu_info_meta` (`im_id`, `info_id`, `im_key`, `im_value`, `im_pid`) VALUES
(1, 1, 'views', '1', 0),
(2, 2, 'views', '231', 0),
(3, 3, 'views', '21', 0),
(5, 5, 'origin_price', '299', 0),
(6, 5, 'current_price', '99', 0),
(7, 6, 'origin_price', '88', 0),
(8, 6, 'current_price', '68', 0),
(9, 8, 'views', '21', 0),
(10, 9, 'views', '21', 0),
(11, 10, 'views', '21', 0),
(12, 11, 'views', '21', 0),
...
(18, 17, 'views', '21', 0),
(19, 18, 'views', '21', 0),
(20, 19, 'current_price', '499', 0),
(21, 20, 'current_price', '10699', 0),
(22, 21, 'current_price', '5799', 0),
(23, 19, 'bimg', '/Public/images/watch.jpg', 0),
(24, 20, 'bimg', '/Public/images/camera.jpg', 0),
(25, 21, 'bimg', '/Public/images/robot.jpg', 0),
(26, 19, 'market_price', '999', 0),
...
(1, '新闻', '/index.php/Home/info?type=1', 1, 1),
(2, '商品', '/index.php/Home/info?type=2', 2, 1),
(3, '文章', NULL, 3, 1),
(4, '就不告诉你', NULL, 4, 0);
...
--
-- Indexes for table `markzhu_info`
--
ALTER TABLE `markzhu_info`
  ADD PRIMARY KEY (`info_id`);

--
-- Indexes for table `markzhu_info_meta`
--
ALTER TABLE `markzhu_info_meta`
  ADD PRIMARY KEY (`im_id`);

--
-- Indexes for table `markzhu_info_widget`
--
ALTER TABLE `markzhu_info_widget`
  ADD PRIMARY KEY (`widget_id`);

--
-- Indexes for table `markzhu_nav`
--
ALTER TABLE `markzhu_nav`
  ADD PRIMARY KEY (`nav_id`);

--
-- Indexes for table `markzhu_news`
--
ALTER TABLE `markzhu_news`
  ADD PRIMARY KEY (`news_id`);

--
-- Indexes for table `markzhu_users`
--
ALTER TABLE `markzhu_users`
  ADD PRIMARY KEY (`user_id`),
  ADD UNIQUE KEY `user_name` (`user_name`);

--
-- Indexes for table `markzhu_users_meta`
--
ALTER TABLE `markzhu_users_meta`
...
--
-- AUTO_INCREMENT for table `markzhu_info`
--
ALTER TABLE `markzhu_info`
...
--
ALTER TABLE `markzhu_info_meta`
  MODIFY `im_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
...
--
-- AUTO_INCREMENT for table `markzhu_nav`
--
ALTER TABLE `markzhu_nav`
  MODIFY `nav_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `markzhu_news`
--
ALTER TABLE `markzhu_news`
  MODIFY `news_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `markzhu_users`
--
ALTER TABLE `markzhu_users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `markzhu_users_meta`
--
ALTER TABLE `markzhu_users_meta`
